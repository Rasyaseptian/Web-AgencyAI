...
const ServiceCard = ({service, index}) => {
  ...
  return (
    ...
    ref={divRef} onMouseMove={handleMouseMove}>
      ...
      via-indigo-500 to-purple-500 w-75 h-75 absolute z-0 transition-opacity duration-500
      mix-blend-lighten ${visible ? 'opacity-70' : 'opacity-0'}`} style={{top: position.y - 150, left: 
      position.x - 150}} />
