...
const ContactUs = () => {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "71346acd-da5f-4042-b370-c585c8f47180");
    try {
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' subTitle='From strategy to execution, we craft digital solutions that move your business forward.' />
        ...
        <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            <div>
                ...
                <div className='flex pl-3 items-center rounded-lg border border-gray-300 dark:border-gray-600'>
                    ...
                    className='w-full p-3 text-sm outline-none bg-transparent' required />
                </div>
            </div>
            <div>
